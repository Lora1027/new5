...
export default function Dashboard(){
  ...
  const totals = useMemo(() => {
    ...
    return { income, expense, net, byMethod, currentMoney }
  }, [tx, balances])
      ...
      <div className="container">
        ...
        <div className="card">
          ...
          <form onSubmit={addTx} className="row">
            <div className="col" style={{gridColumn:'span 2'}}><label>Date</label><input className="input" type="date" name="date" required/></div>
            <div className="col" style={{gridColumn:'span 2'}}><label>Type</label>
              <select name="type" className="input" required>
                <option value="income">Income</option>
                <option value="expense">Expense</option>
              </select>
            </div>
            <div className="col" style={{gridColumn:'span 3'}}><label>Category</label><input className="input" name="category" placeholder="e.g. Sales / Rent / COGS"/></div>
            <div className="col" style={{gridColumn:'span 2'}}><label>Method of Payment</label>
            ...
            <div className="col" style={{gridColumn:'span 2'}}><label>Amount</label><input className="input" name="amount" type="number" step="0.01" required/></div>
            <div className="col" style={{gridColumn:'span 12'}}><label>Notes</label><input className="input" name="notes" placeholder="optional"/></div>
            <div className="col" style={{gridColumn:'span 12'}}><button className="btn">Save</button></div>
          </form>
        </div>
        ...
        <div className="card">
          ...
          <form onSubmit={addBalance} className="row">
            ...
            <div style={{gridColumn:'span 3'}}><label>Kind</label>
